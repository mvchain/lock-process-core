...
public class ReflectionUtils {
    ...
    public static Object invokeGetter(Object obj, String propertyName) {
        Object object = obj;
        for (String name : StringUtils.split(propertyName, PROP_SEPARATOR)) {
    ...
    public static void makeAccessible(Method method) {
        boolean isModifier = !Modifier.isPublic(method.getModifiers());
        boolean isPublic = Modifier.isPublic(method.getDeclaringClass().getModifiers());
        if ((isModifier || !isPublic)
                && !method.isAccessible()) {
    ...
    public static void makeAccessible(Field field) {
        ...
        boolean isModifier = Modifier.isPublic(field.getDeclaringClass().getModifiers());
        boolean isFinal = Modifier.isFinal(field.getModifiers());
        if ((!isPublic || !isModifier || isFinal) && !field.isAccessible()) {
