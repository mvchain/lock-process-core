...
public class UserController extends BaseController<UserService,User> {
    ...
    public @ResponseBody Result createUser(@RequestBody @Valid UserDTO user) {
    ...
    public @ResponseBody BaseResponse forget(@RequestBody @Valid ForgetDTO user){
    ...
    public @ResponseBody BaseResponse updatePwd(@RequestBody @Valid ForgetDTO userDTO){
        userDTO.setCellphone(BaseContextHandler.getUsername());
    ...
    @RequestMapping(value = "cellPhone", method = RequestMethod.POST)
     public @ResponseBody BaseResponse updatePhone(@RequestBody @Valid UpdatePhoneDTO updatePhoneDTO){
